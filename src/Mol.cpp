...
#include "headers/Mol.h"

Mol::Mol(int _natoms, double *_x, double *_y, double *_z, double *_eps, double *_sig, double *_q)
  : natoms(_natoms), x(_x), y(_y), z(_z), eps(_eps), sig(_sig), q(_q) { };
