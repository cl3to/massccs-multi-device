...
Force::Force(Mol *_moleculeTarget, LCL *_linkedcell, double _lj_cutoff, double _alpha, double _coul_cutoff) 
           : moleculeTarget(_moleculeTarget), linkedcell(_linkedcell), lj_cutoff(_lj_cutoff), alpha(_alpha), coul_cutoff(_coul_cutoff) {
 ...
 */
void Force::lennardjones_LC(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
...
void Force::lennardjones(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
 ...
 **/
void Force::lennardjones_coulomb(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
 ...
 **/
void Force::coulomb(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz;
double dx, dy, dz;
double r2,r;
 ...
 **/
void Force::lennardjones_induced_dipole_LC(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
...
void Force::lennardjones_induced_dipole(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, Ulj, flj, U;
double dx, dy, dz;
double epsilon, sigma;
 ...
 */
void Force::lennardjones_coulomb_LC(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, Ulj, flj, U;
double dx, dy, dz;
double epsilon, sigma;
 ...
 **/
void Force::coulomb_LC(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy, fz, Ulj, flj, U;
double dx, dy, dz;
double r2, r;
...
void Force::coulomb_induced_dipole_iso(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, U;
double dx, dy, dz;
double r2, x2, y2, z2, r;
...
void Force::coulomb_induced_dipole_iso_LC(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, U;
double dx, dy, dz;
double r2, x2, y2, z2, r;
 ...
 */
void Force::lennardjones_LC_CO2(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy, fz, U, Ulj, flj, Ulj_cut;    
double dx, dy, dz;
double epsilon, sigma;
...
void Force::lennardjones_CO2(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, Ulj, flj;
double dx, dy, dz;
double epsilon, sigma;
 ...
 */
void Force::lennardjones_coulomb_LC_CO2(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, Ulj, flj, U;
double dx, dy, dz;
double epsilon, sigma;
 ...
 * Compute the lennard jones and coulomb interactions
 **/
void Force::lennardjones_coulomb_CO2(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
 ...
 **/
void Force::lennardjones_coulomb_induced_dipole_iso_LC_CO2(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, Ulj, flj, U, Ulj_cut;
double dx, dy, dz;
double epsilon, sigma;
...
void Force::lennardjones_coulomb_induced_dipole_iso_CO2(GasProbe *gas, int iatom, vector<double> &f, double &Up) {
double r_probe[3];
double fx, fy,fz, Ulj, flj, U, Ucoul, fcoul;
double dx, dy, dz;
double epsilon, sigma;
