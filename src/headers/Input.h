...
#ifndef MASSCCS_OMPC_V1_INPUT_H
#define MASSCCS_OMPC_V1_INPUT_H
...
public:
  ...
  unsigned int ntask;                // numbers of task, default use the numbers of node 
  unsigned int nthreads;             // numbers of threads, default use all core per node
