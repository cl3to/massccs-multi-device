...
#ifndef MASSCCS_OMPC_V1_SYSTEM_H
#define MASSCCS_OMPC_V1_SYSTEM_H
...
class System {
private:
  unsigned int seed, nProbe, nIter, equipotential_flag, gas_buffer_flag, nthreads, ntask, nlocal;
  ...
  void setup(GasProbe *gasProbe,bool &hit, double rndVal1, double rndVal2, double rndVal3, double rndVal4, double rndVal5, 
...
public:
  ...
  void run_He(GasProbe *gasProbe, bool &success, double &chi, double dt, Force *force);
  void run_N2(GasProbe *gasProbe, bool &success, double &chi, double dt, Force *force);
  void run_CO2(GasProbe *gasProbe, bool &success, double &chi, double dt, Force *force);
